...
#define P_GEN_6_CROSS_EVOS               FALSE // Just Sylveon. Not enabling fairy type, so leaving disabled
//#define P_GEN_7_CROSS_EVOS             // Alolan evolutions handled by P_ALOLAN_FORMS.
#define P_GEN_8_CROSS_EVOS               P_CROSS_GENERATION_EVOS // Regional evolutions handled by P_GALARIAN_FORMS and P_HISUIAN_FORMS. Includes Kleavor, Ursaluna, Wyrdeer
#define P_GEN_9_CROSS_EVOS               P_CROSS_GENERATION_EVOS // Clodsire handled by P_PALDEAN_FORMS. Includes Annihilape, Faragiraf, Dudunsparce, Kingambit, Dipplin, Applin, Archaludon
