...
u32 GetCurrentLevelCap(void)
{
    ...
    static const u32 sLevelCapFlagMap[][2] =
    {
        ...
        {FLAG_BADGE04_GET,    37}, // TRAINER_LEADER_ERIKA
        {FLAG_BEAT_RIVAL_5,   43}, // TRAINER_RIVAL_SILPH
        {FLAG_HIDE_SAFFRON_ROCKETS, 45}, // TRAINER_BOSS_GIOVANNI_2
        {FLAG_BADGE05_GET,    47}, // TRAINER_LEADER_SABRINA
        {FLAG_BADGE06_GET,    52}, // TRAINER_LEADER_KOGA
        {FLAG_BADGE07_GET,    55}, // TRAINER_LEADER_BLAINE
        {FLAG_BADGE08_GET,    57}, // TRAINER_LEADER_GIOVANNI
        {FLAG_BEAT_RIVAL_6,   60}, // TRAINER_RIVAL_ROUTE22_LATE
        {FLAG_DEFEATED_LORELEI_1X, 67}, // TRAINER_ELITE_FOUR_LORELEI
        {FLAG_DEFEATED_BRUNO_1X,   68}, // TRAINER_ELITE_FOUR_BRUNO
        {FLAG_DEFEATED_AGATHA_1X,  69}, // TRAINER_ELITE_FOUR_AGATHA
        {FLAG_DEFEATED_LANCE_1X,   70}, // TRAINER_ELITE_FOUR_LANCE
        {FLAG_DEFEATED_CHAMP_1X,   72}, // TRAINER_CHAMPION_FIRST
