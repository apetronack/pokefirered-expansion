...
static const u8 *const sLocationNameTexts[] =
{
    ...
    [QL_LOCATION_RIOLUS_CAVE_1]    = gText_QuestLog_DiglettsCave,
    [QL_LOCATION_RIOLUS_CAVE_2]    = gText_QuestLog_DiglettsCave,
...
static const u8 sLocationToDepartedTextId[] =
{
    ...
    [QL_LOCATION_RIOLUS_CAVE_1]    = QL_DEPARTED_CAVE,
    [QL_LOCATION_RIOLUS_CAVE_2]    = QL_DEPARTED_CAVE,
